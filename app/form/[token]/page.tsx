...
const options = [['Não possui', 0], ['Em planejamento', 25], ['Parcialmente implementado', 50], ['Implementado', 75], ['Implementado e monitorado', 100]] as const;
...
export default function PublicForm() {
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-4 p-3 sm:space-y-5 sm:p-6">
      <h1 className="text-2xl font-semibold sm:text-3xl">Diagnóstico ESG</h1>
