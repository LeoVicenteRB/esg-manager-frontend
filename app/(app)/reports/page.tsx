...
export default function Reports() {
  ...
  return (
    <div className="space-y-5 lg:space-y-6">
      <div><h1 className="text-2xl font-semibold sm:text-3xl">Relatorios</h1><p className="text-sm text-slate-500 sm:text-base">Formularios enviados, score, classificação e PDF.</p></div>
